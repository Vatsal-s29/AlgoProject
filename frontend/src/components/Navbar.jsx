...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 w-full h-12 bg-gray-100 px-6 flex items-center justify-between border-b border-gray-200 z-50">
            ...
            <div className="flex items-center gap-4">
                {/* Theme toggle icon (no functionality implemented yet) */}
                {/* <button
